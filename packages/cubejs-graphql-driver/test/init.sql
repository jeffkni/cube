CREATE TABLE visitors (id INT, amount INT, created_at DATE, updated_at DATE, status INT, source TEXT, latitude DECIMAL, longitude DECIMAL);
CREATE TABLE visitor_checkins (id INT, visitor_id INT, created_at DATE, source TEXT);
